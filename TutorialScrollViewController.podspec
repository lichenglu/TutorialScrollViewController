...
Pod::Spec.new do |s|
  ...
  s.version          = "0.1.0"
  s.summary          = "A short description of TutorialScrollViewController."
...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/TutorialScrollViewController.git", :tag => s.version.to_s }
